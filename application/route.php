...
//    '/' => 'admin/index/index', // 首页访问路由
    ...
    'userDelById' => ['admin/index/user_del', ['method' => 'get']],
    'userDelAll' => ['admin/index/user_del_all', ['method' => 'get']],
    'saveAdmin' => ['admin/index/save_admin', ['method' => 'post']],
    'adminEdit/:id' => ['admin/index/admin_edit', ['method' => 'get']],
    'userEdit/:id' => ['admin/index/user_edit', ['method' => 'get']],
    'changePsw' => ['admin/index/change_psw', ['method' => 'get']],
    'saveChangePsw' => ['admin/index/save_change_psw', ['method' => 'post']],
    ...
    'notice' => ['admin/article/notice', ['method' => 'get']],
    'addNotice' => ['admin/article/add_notice', ['method' => 'get']],
    'noticeSave' => ['admin/article/notice_save', ['method' => 'post']],
    'noticeEdit/:id' => ['admin/article/notice_edit', ['method' => 'get']],
    'noticeDel/:id' => ['admin/article/notice_del', ['method' => 'get']],
    'noticeDelAll' => ['admin/article/notice_del_all', ['method' => 'get']],
    'noticeStatus/:id' => ['admin/article/notice_status', ['method' => 'get']],
    ...
    'userList' => ['admin/index/user_list', ['method' => 'get']],
    'saveUser' => ['admin/index/save_user', ['method' => 'post']],
...
Route::group('',[
    ...
    'buy' => ['buy', ['method' => 'get']],
    'forget' => ['User/forget', ['method' => 'get']],
    'sendEmail' => ['User/send_email', ['method' => 'post']],
    'checkEmail' => ['User/check_email', ['method' => 'post']],
    'changePsw/:id' => ['User/change_psw', ['method' => 'get']],
    'saveCPSW' => ['User/save_c_psw', ['method' => 'post']],

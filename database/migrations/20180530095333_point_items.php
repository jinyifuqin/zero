...
class PointItems extends Migrator
{
    /**
     * Change Method.
     *
    ...
    {
        $table  = $this->table('point_items',array('engine'=>'MyISAM'));
        $table->addColumn('sort', 'integer',array('limit' => 32,'default'=>0,'comment'=>'排序'))
            ...
            ->addColumn('price', 'integer',array('limit' => 32,'default'=>0,'signed'=>false,'comment'=>'商品积分价格'))

...
class Items extends Migrator
{
    ...
    public function change()
    {
        ...
        $table->addColumn('sort', 'integer',array('limit' => 32,'default'=>0,'comment'=>'排序'))
            ...
            ->addColumn('a_price', 'integer',array('limit' => 32,'default'=>0,'signed'=>false,'comment'=>'分销商A商品价格'))
            ->addColumn('b_price', 'integer',array('limit' => 32,'default'=>0,'signed'=>false,'comment'=>'分销商B商品价格'))
            ->addColumn('c_price', 'integer',array('limit' => 32,'default'=>0,'signed'=>false,'comment'=>'分销商C商品价格'))
            ->addColumn('d_price', 'integer',array('limit' => 32,'default'=>0,'signed'=>false,'comment'=>'分销商D商品价格'))
